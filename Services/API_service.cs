...
namespace APPCurrency_API.Services
{
    internal class API_services
    {
        ...
        {
            string url = $"{base_url}{api_key}/pair/{base_currency}/{target_currency}/{amount}"; // pre made HTTPS request
        ...
        {
            string api_key = "3caa68ca93b364b46e7dab87"; // create anyway a api key 

            string url = $"{base_url}{api_key}/codes"; // pre made HTTPS request
